<template>
  <main class="container mx-auto lg:w-1/2 space-y-4 mb-4">
    <h2 class="font-bold text-xl text-redline">Redline Terms of Service</h2>
    <h3 class="font-bold">1. Terms</h3>
    <p>
      By accessing the website at
      <a class="text-rl-blue" href="https://redline.wouterv.dev"
        >https://redline.wouterv.dev</a
    ...
    <ul class="list-disc ml-4 space-y-2">
      <li>
        ...
        (information or software) on Redline's website for personal,
        ...
        <ul class="list-disc ml-4 space-y-2 my-2">
      ...
      <li>
        ...
        restrictions and may be terminated by Redline at any time. Upon
    ...
    <ul class="list-disc ml-4 space-y-2">
      <li>
        The materials on Redline's website are provided on an 'as is' basis.
        Redline makes no warranties, expressed or implied, and hereby disclaims
      ...
      <li>
        Further, Redline does not warrant or make any representations concerning
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Redline or its suppliers be liable for any damages
      ...
      materials on Redline's website, even if Redline or a Redline authorised
    ...
    <p>
      The materials appearing on Redline's website could include technical,
      typographical, or photographic errors. Redline does not warrant that any
      of the materials on its website are accurate, complete or current. Redline
      may make changes to the materials contained on its website at any time
      without notice. However Redline does not make any commitment to update the
      materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Redline has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement by Redline of the site. Use of any such
      linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Redline may revise these terms of service for its website at any time
    ...
    <p>
      <a
        ...
        >Terms of Use created with GetTerms.</a
      >
    </p>
  </main>
</template>
