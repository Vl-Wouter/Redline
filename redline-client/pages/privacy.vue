<template>
  <main>
    <h1>Privacy Policy for Redline</h1>

    <p>
      At Redline, accessible from localhost, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by Redline and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Redline. This policy is not applicable to any
    ...
    <p>
      Redline follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Redline uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of Redline.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Redline, which are sent directly
    ...
    <p>
      Note that Redline has no access to or control over these cookies that are
    ...
    <p>
      Redline's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Redline does not knowingly collect any Personal Identifiable Information
